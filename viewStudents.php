...
<!-- #404040 side font color -->
    <div class="container">
        ...
        <div class="main"  style="background: rgb(229, 229, 229) !important;height:90vh;"> 
            ...
            <div id="SIDE" style="margin-top:2%;margin-left:1%;margin-right:3%;">
                ...
                <div class="last" style="background:white; margin-top:20px; width:100%; height:5vh">
                </div>
                
                <table width="100%" style="color:#404040; border:0px">
	<thead >
		<tr style="background:rgb(240, 240, 240) !important;height:6vh;">
			<th width="10%">Admission Number</th>
			<th width="10%">First Name</th>
			<th width="10%">Last Name</th>
            <th width="10%">Class of Entry</th>
            <th width="10%">Gender</th>
            <th width="10%">Parent Name</th>
            <th width="10%">Parent Contact</th>
    ...
    <?php 
        ...
        while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
            <tr class="xx" style="text-align:center;height:5vh;">
                <td><?php echo $row['admissionNum']; ?></td>
                <td><?php echo $row['firstName']; ?></td>
                <td><?php echo $row['lastName']; ?></td>
                <td><?php echo $row['classOfEntry']; ?></td>
                <td><?php echo $row['gender']; ?></td>
                <td><?php echo $row['parentName']; ?></td>
                <td><?php echo $row['phoneNum']; ?></td>
                <td>
                    <a href="JesusSave.php?edit=<?php echo $row['admissionNum']; ?>">View Result</a></td>
                  <td>  <a href="server.php?deli=<?php echo $row['id']; ?>" class="del_btn">Delete</a>
                </td>
            </tr>
	<?php } ?> 
</table>
