    ...
    <div class="container">
        ...
        <div class="main"  style="background: rgb(229, 229, 229) !important; height: 90vh; "> 
            ...
            <div id="SIDE" style="margin-top:2%;margin-left:1%;margin-right:3%;">
                ...
                <div class="last" style="background:white; margin-top:20px; width:100%;">
                    <div style="padding:20px">
                    <form method="post" action="server.php" enctype="multipart/form-data" name="usersForm">
                        <label class="label"> Admission Number </label> <input class="inn" type="text" name="adminNum" required> <br/>
                        <label class="label"> LastName </label> <input class="inn" type="text" name="studentlname" required><br/>
                        <label class="label"> FirstNme </label> <input class="inn" type="text" name="studentfname" required><br/>
                        <label class="label"> Date of Birth </label> <input class="inn" type="text" name="studentDob" required><br/>
                        <label class="label"> Class of Entry </label>
                        <select class="inn" id="ClassofEntry" name="sClass" required>
                            <option value="">--Please choose an option--</option>
                            <option value="jss1">JSS1</opion>
                            <option value="jss2">JSS2</opion>
                            <option value="jss3">JSS3</opion>
                            <option value="sss1">SSS1</opion>
                            <option value="sss2">SSS2</opion>
                            <option value="sss3">SSS3</opion>
                        </select> <br/>
                        <label class="label"> Term of Entry </label>  
                        <select class="inn" id="TermofEntry" name="sTerm" required>
                            <option value="">--Please choose an option--</option>
                        ...
                        <label class="label"> Session of Entry </label> 
                        <select class="inn" id="SessionofEntry" name="session" required>
                            <option value="">--Please choose an option--</option>
                        ...
                        <label class="label"> Gender </label> <input class="inn" type="text" name="studentGender" required> <br/>
                        <label class="label"> Parent/Guidian Name </label> <input class="inn" type="text" name="pname" required><br/>
                        <label class="label"> Parent Contact Address </label> <input class="inn" type="text" name="padd" required><br/>
                        <label class="label"> Parent Phone Number </label> <input class="inn" type="text" name="pnum" required><br/>
                        <button class="inn" name="save" class="btn" type="submit" onclick="submit()" style="margin:20px; margin-left:30px;">Save</button>
        </form>
                    </div>
